<div class="sidebar bg-light border-e border-e-gray-200 fixed top-0 bottom-0 z-20 hidden lg:flex flex-col items-stretch shrink-0"
    ...
    <div class="sidebar-content flex grow shrink-0 py-5 pe-2" id="sidebar_content">
        <div class="scrollable-y-hover grow shrink-0 flex ps-2 lg:ps-5 pe-1 lg:pe-3" data-scrollable="true"
            ...
            <div class="menu flex flex-col grow gap-0.5" data-menu="true" data-menu-accordion-expand-all="false"
                    ...
                    <div
                        ...
                        <div class="menu-item" data-menu-item-toggle="accordion" data-menu-item-trigger="click">
                            ...
                            <div
                                ...
                                <div class="menu-item">
                                    <a class="menu-link border border-transparent items-center grow menu-item-active:bg-secondary-active menu-item-active:rounded-lg hover:bg-secondary-active hover:rounded-lg gap-[5px] ps-[10px] pe-[10px] py-[8px]"
                ...
                <div class="menu-item">
                    <div class="menu-label border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]" href=""
                        tabindex="0">
                        <span class="menu-icon items-start text-gray-500 w-[20px]">
                            <i class="ki-filled ki-users text-lg">
                            </i>
